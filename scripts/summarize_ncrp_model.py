...
(node_term_dist, term_node_dist, node_doc_dist, doc_node_dist, prev, alpha, eta, V, T) = load_all_ncrp_samples(SampleBase, MapOrBayes, ToKeep=10)

# Print out a summary of the node-term distributions
for node, terms in node_term_dist.iteritems():
    print 'Node:', node, 'Parents:', prev[node]
